...
export class CreateScholarship1703094449669 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "professor" ADD "scholarship_id" integer`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "professor" DROP CONSTRAINT "FK_ecf3734ccd39b5a672178dddf1d"`);
    await queryRunner.query(`ALTER TABLE "professor" DROP COLUMN "scholarship_id"`);
